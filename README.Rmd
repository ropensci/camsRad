...
Get hourly CAMS solar data into a R data frame. For the location 
60° latitude and 15° longitude, and for period 2016-01-01 to 2016-01-15.
```{r eval=FALSE}
...
```
### Example 2
Retrieve daily CAMS solar data in ncdf format. You need to have `ncdf4` installed
```{r eval=FALSE}
library(ncdf4)
